...
describe("doctor fixture contract", () => {
  it("contains doctor role done payload and dashboard cards", () => {
    const fixturePath = join(process.cwd(), "tests/fixtures/orchestrator/doctor-followup-journey.json");
    ...
    expect(done?.data.role).toBe("doctor");
